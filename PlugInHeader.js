...
$.PlugInHeader = function(params){
    ...
    if(params['leftMenu']){
        $.each(params['leftMenu'],function(i,n){
            nav_left_menu.append(menu_li(n));
        });
    }
    //右侧菜单
    ...
    if(params['rightMenu']){
        $.each(params['rightMenu'],function(i,n){
            nav_right_menu.append(menu_li(n));
        });
    }
};
...
function menu_li(n){
    var menu_li=$("<li></li>");
    var menu_li_a=$("<a href='#'></a>");menu_li.append(menu_li_a);
    if(n['ico']){
    ...
    if(n['child']){
        ...
        $.each(n['child'],function(j,m){
            var menu_ul_li=$("<li><a href='#'>"+m+"</a></a></li>");menu_ul.append(menu_ul_li);
